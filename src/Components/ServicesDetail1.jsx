...
function ServicesDetail1({apiData}) {
  return (
        ...
        {apiData && (
          ...
          <div className="col-lg-8">
            <div className="service_details_img fade_up">
              <img
                src={apiData.user.services[0].image.url}
                alt="services"
                className="img-fluid w-100" />
            </div>
            <div className="service_details_text">
              <h2 className="has-animation">{apiData.user.services[0].name}</h2>
              <p>
              ...
              <div className="row mb_55">
                ...
                <div className="col-6">
                  <div className="service_details_small_img fade_up">
                    <img
                      src={apiData.user.services[2].image.url}
                      alt="Services"
                      className="img-fluid w-100" />
                  </div>
                </div>
          ...
          <div className="col-lg-4">
            <div className="sidebar" id="sticky_sidebar">
              <div className="sidebar_services">
                <h3>service list</h3>
                <ul>
                  {apiData.user && apiData.user.services && apiData.user.services.map((service, index) =>(
                    <li key={index}>
                  ...
                  {/* <li><a href="service_details.html">Web Development</a></li>
                  <li><a href="service_details.html">UI/UX Design</a></li>
                  <li><a href="service_details.html">Sound Design</a></li>
                  <li><a href="service_details.html">Game Design</a></li>
                  <li><a href="service_details.html">Branding Design</a></li>
                  <li><a href="service_details.html">Digital Marketing</a></li> */}
                </ul>
              </div>
